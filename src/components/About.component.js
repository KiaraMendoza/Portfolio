      ...
      <main id="about" className="about d-flex justify-content-center flex-column" >
        <div className="row container d-flex justify-content-center mx-auto">
          <div className="about-me-paragraph col-12 col-md-6">
            ...
            <p>
              I'm Kiara Mendoza García, a self-teach web developer student. I've been loving tech since I can remember. 
              ...
              and now its like every tutorial I saw about web development that can help me keep improving my projects.
          </p>
            <p>
              At the moment I'm looking for an internship or a junior position to continue learning.
          </p>
            <div className="row mt-5 mx-0 contact-icons-row">
              ...
              <div className="col-auto"><a href="/CV-Kiara-2020-EN.pdf"><i onMouseEnter={this.addAnimateClass}  className="fas fa-print pr-2"></i></a></div>
            </div>
          </div>
